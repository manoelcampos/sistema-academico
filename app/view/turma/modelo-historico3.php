...
?>
 ...
 ?>
    ...
    <table class="borderless" CELLPADDING="0" CELLSPACING="0" style="position: relative; bottom: -100px; width: 100%">
    <tr>
      <td align="center">
    ...
    <table id="pg_verso" class="borderless" CELLPADDING="0" CELLSPACING="0" > <!-- 915-->
